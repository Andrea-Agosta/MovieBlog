  ...
  return (
    <div className="card card-width m-2 shadow p-3 mb-5 bg-body rounded" onClick={() => handleClick(data)} >
      <Link to={`/movie/${data.id}`} className="text-decoration-none" >
        <img src={index === 1 ? 'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1330717350l/13508283.jpg' : data.large_cover_image} className="card-img-top card-img-high" alt="movie_image" />
